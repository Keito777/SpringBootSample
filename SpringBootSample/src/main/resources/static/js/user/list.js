...
function createDataTables() {
  ...
  table = $('#user-list-table').DataTable({
    ...
    //表示データ（DataTablesに検索結果のJSON(userData)を渡す）
    data: userData,
    //データと列のマッピング（テーブルのどの列に、JSON喉のデータを表示するのかを指定）
    columns: [
      { data: 'userId'}, // ユーザーID
      { data: 'userName'}, // ユーザー名
      {
